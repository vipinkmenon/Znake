 ...
 *
 * @param   BaseAddress is the base address of the TIMERdevice.
 ...
 * @note
 * C-style signature:
 * 	void TIMER_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 TIMER_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
